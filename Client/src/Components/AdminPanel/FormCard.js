...
const FormCard = (props) => {
  ...
  const handleApprove = async () => {
    ...
    try {
      const response = await fetch(
        `https://paws-for-u-backend.onrender.com/approving/${props.form.petId}`,
        {
          method: "PUT",
          body: JSON.stringify({
  ...
  const deleteFormAdoptedPet = async () => {
    try {
      const deleteResponse = await fetch(
        `https://paws-for-u-backend.onrender.com/form/delete/many/${props.form.petId}`,
        {
          method: "DELETE",
        }
      );
  ...
  const handleReject = async () => {
    ...
    try {
      const response = await fetch(
        `https://paws-for-u-backend.onrender.com/form/reject/${props.form._id}`,
        {
          method: "DELETE",
        }
      );
